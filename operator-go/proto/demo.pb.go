...
var file_demo_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x75, 0x65, 0x32, 0x79, 0x0a, 0x06, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x12, 0x36,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x37, 0x0a, 0x06, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x32,
	0x12, 0x14, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x15, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x53,
	0x69, 0x6d, 0x70, 0x6c, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42,
...
var file_demo_proto_depIdxs = []int32{
	...
	0, // 1: proto.Simple.Route2:input_type -> proto.SimpleRequest
	1, // 2: proto.Simple.Route:output_type -> proto.SimpleResponse
	1, // 3: proto.Simple.Route2:output_type -> proto.SimpleResponse
...
type SimpleClient interface {
	...
	Route2(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (*SimpleResponse, error)
}
...
func (c *simpleClient) Route2(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (*SimpleResponse, error) {
	out := new(SimpleResponse)
	err := c.cc.Invoke(ctx, "/proto.Simple/Route2", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SimpleServer interface {
	...
	Route2(context.Context, *SimpleRequest) (*SimpleResponse, error)
}
...
func (*UnimplementedSimpleServer) Route2(context.Context, *SimpleRequest) (*SimpleResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Route2 not implemented")
}
...
func _Simple_Route2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SimpleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SimpleServer).Route2(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Simple/Route2",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SimpleServer).Route2(ctx, req.(*SimpleRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Simple_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Route2",
			Handler:    _Simple_Route2_Handler,
		},
	},

...
import (
	...
	tscuitev1 "github.com/tscuite/tscuite-operator/operator-go/api/v1"
	"github.com/tscuite/tscuite-operator/operator-go/controllers"
	"github.com/tscuite/tscuite-operator/operator-go/grpc"
